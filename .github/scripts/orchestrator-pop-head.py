...
def main():
    ...
    if commit:
        ...
        defaults = {
            ...
            "tracker": "",
            "doi": "pending",
            "current_version": "v1-preprint",  # 2026-05-17 — for framework-uplift + back-rev transitions
            "reason": "",                       # 2026-05-17 — for back-rev transition (audit-trail)
        }
        ...
        for k in ("slug", "transition", "target_label", "source_repo", "source_path",
                  "addendum_path", "title_suffix", "tracker", "doi", "current_version", "reason"):
